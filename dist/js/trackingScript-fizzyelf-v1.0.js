...
async function FillTracker(username, params = {}) {
    ...
    const config = {
      ...
      trackerwrap: params.thisTracker || $('tag-tab[data-type="#active"]'),
      historywrap: params.thisHistory || $('tag-tab[data-type="#archived"]'),
      commwrap: params.thisCommTracker || $('tag-tab[data-type="#comms"]'),
      socialwrap: params.thisSocialTracker || $('tag-tab[data-type="#socials"]'),
      devwrap: params.thisDevTracker || $('tag-tab[data-type="#dev"]'),
      reqwrap: params.thisDevTracker || $('tag-tab[data-type="#requests"]'),
