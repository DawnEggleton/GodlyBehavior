...
async function FillTracker(username, params = {}) {
    ...
    const config = {
      ...
      trackerwrap: params.thisTracker || $('tag-tab[data-tag="#active"]'),
      historywrap: params.thisHistory || $('tag-tab[data-tag="#archived"]'),
      commwrap: params.thisCommTracker || $('tag-tab[data-tag="#comms"]'),
      socialwrap: params.thisSocialTracker || $('tag-tab[data-tag="#socials"]'),
      devwrap: params.thisDevTracker || $('tag-tab[data-tag="#dev"]'),
      reqwrap: params.thisDevTracker || $('tag-tab[data-tag="#requests"]'),
